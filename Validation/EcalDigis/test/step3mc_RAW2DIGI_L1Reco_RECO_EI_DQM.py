...
# with command line options: step3mc --mc --eventcontent AODSIM,DQM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --datatier AODSIM,DQMIO --conditions 75X_mcRun2_HeavyIon_v13 --step RAW2DIGI,L1Reco,RECO,EI,DQM --scenario HeavyIons
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step3mc nevts:1'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3mc_RAW2DIGI_L1Reco_RECO_EI_DQM.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('step3mc_RAW2DIGI_L1Reco_RECO_EI_DQM_inDQM.root'),
...
process.schedule = cms.Schedule(process.raw2digi_step,process.L1Reco_step,process.reconstruction_step,
      ...
      process.dqmoffline_step,process.AODSIMoutput_step,process.DQMoutput_step)
