...
config.General.requestName = 'NuGun_PU200_unclsel_xyseed_20201118'
...
# config.Data.outLFNDirBase = '/store/group/phys_heavyions/echapon/HGCal/l1jetperf/fulltowers' 
config.Data.outLFNDirBase = '/store/group/phys_heavyions/echapon/HGCal/l1jetperf/unclseltowers' 
